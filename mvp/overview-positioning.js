(function renderFoundationToolkitOverview() {
  ...
  hero.insertAdjacentHTML("afterend", `<section class="section panel playbook-overview hero-overview foundation-toolkit-overview">
    ...
    <div class="overview-grid toolkit-scope-grid">
      ...
      <article class="mini-card"><h3>Tools</h3><p>The Full Version includes 49 fillable assessments, policies, charters, checklists, plans, vendor and procurement reviews, validation records, dashboards, audits, incident records, and improvement logs. The Foundation Edition provides one usable tool per play.</p></article>

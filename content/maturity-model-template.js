(function () {
  function render(options = {}) {
    ...
    const toolLink = options.toolLink || (id => foundation ? `<a href="tool.html?play=${id}">Play ${id} Foundation Tool</a>` : `<a href="#/toolkit/${id}">Tool ${id}</a>`);

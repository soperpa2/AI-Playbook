/**
 * Essentials play-detail renderer. Canonical play content comes from
...
<div class="detail-layout"><article class="page-panel">
  ...
  <section class="page-panel tool-panel" id="starter-tool" data-content-id="${play.tool.id}"><p class="eyebrow">Included Essentials Tool</p><h2>${play.tool.title}</h2><p>${play.tool.purpose}</p><p class="availability">This practical tool is included and ready to use in the Essentials Edition.</p><a class="button primary" href="tool.html?play=${play.number}">Open this tool</a></section>

...
const plays = fullPlayContent.map(play => {
  const publicRecord = window.launchContent?.plays?.find(item => item.number === play.id);
  if (!publicRecord) return play;
  return {
    ...play,
    phase: publicRecord.phase,
    title: publicRecord.title,
    public_id: publicRecord.id,
    slug: publicRecord.slug,
    audiences: publicRecord.audiences,
    evidence_strength: publicRecord.evidence,
    public_summary: publicRecord.summary,
    starter_tool: publicRecord.tool
  };
});
...
const playCardDescriptions = {
  ...
  8: "Align approved AI priorities with grants, budgets, staffing, procurement, infrastructure, evaluation, and sustainment resources before implementation plan commitments are finalized.",
  9: "Translate approved use cases, readiness gaps, funding assumptions, governance gates, infrastructure needs, staffing, and dependencies into a sequenced implementation plan.",
...
const tools = [
  ...
  [36,"AI Implementation Timeline",[9,11],"Sequence milestones, dependencies, approvals, pilot phases, and scale decisions.","Planning","Implementation planning",["PMO","IT"],"Readiness",true],
  [37,"Implementation Plan Dependency and Risk Register",[9,11,12],"Track implementation plan dependencies, governance gates, risks, owners, due dates, mitigation actions, and escalation decisions.","Register","Implementation planning",["PMO","Governance","IT"],"Readiness",true],
...
const toolFormBlueprints = {
  ...
  7: [["Validation setup", ["Agency/division", "Pathway Assessment date", "Validation session date", "Facilitator", "Executive sponsor or approving authority", "Participating roles"]], ["Finding validation", ["Assessment domain and preliminary score", "Preliminary finding or recommendation", "Evidence or source", "Evidence owner", "Validation status", "Assumptions, disagreements, and unknowns", "Validated finding"]], ["Gap and improvement register", ["Validated readiness gap", "Gap classification", "Risk and priority", "Improvement action", "Responsible owner", "Approver", "Target date", "Dependencies", "Evidence required for closure", "Related play and tool", "Status"]], ["Decision and reassessment", ["Activities to proceed", "Activities to pause or delay", "30-day actions", "60-day actions", "90-day actions", "Leadership or governance decision", "Reassessment date", "Reassessment triggers"]]],
  ...
  26: [["Implementation plan overview", ["Planning period", "Strategic priorities", "Approved use cases", "Shared dependencies"]], ["Timeline", ["Quarter 1 milestones", "Quarter 2 milestones", "Quarter 3 milestones", "Quarter 4 milestones", "12-36 month implementation plan items"]], ["Governance and resources", ["Approval gates", "Funding dependencies", "Staffing dependencies", "Risks to timeline", "Next update date"]]],
...
const toolOutputOverrides = {
  ...
  36: [
    ...
    "Implementation planning period, strategic priorities, approved use cases, and shared dependencies.",
    ...
    "Implementation plan owner and next update date."
  ],
  32: [
  ...
  35: [
    ...
    "Decision or next action for funding strategy and implementation plan sequencing."
  ],
  37: [
    "Implementation plan dependency and risk register.",
    "Implementation plan item, related play or use case, owner, target date, and status.",
...
const playOutputDetails = {
  ...
  2: [
    "Imported AI Readiness and Pathway Assessment results, or equivalent organizational assessment evidence.",
    "Completed Readiness Findings Validation & Improvement Plan.",
  ...
  8: [
    "Funding strategy for the AI implementation plan.",
  ...
  9: [
    "Governance-approved AI implementation plan.",
    ...
    "Implementation plan dependency and risk register.",
    "Risk register for implementation plan delivery.",
    "Implementation plan update cadence and ownership."
  ],
  10: [
...
const playGuidanceDetails = {
  ...
  9: {
    eyebrow: "Implementation Planning Guidance",
    title: "Turn resourced use cases into a sequenced implementation plan",
    body: "Use this play to connect approved use cases and funding assumptions to timelines, dependencies, governance gates, staffing, infrastructure, procurement, training, change support, and evaluation. The implementation plan should prevent isolated pilots by showing what needs to happen before each project can safely move forward.",
    bullets: ["Sequence work by dependency, readiness, and resourcing, not enthusiasm alone.", "Make governance reviews, readiness gates, funding assumptions, and change supports visible in the timeline.", "Update the implementation plan regularly as funding, staffing, technology, and risk conditions change."],
    link: ["Open implementation planning guidance", "#/play-guides/play-9"]
  },
  10: {
...
const playGuideDeepDive = {
  ...
  8: {
    purpose: "Identify funding sources, cost assumptions, procurement implications, and sustainment strategies before the implementation plan is finalized.",
    timing: "Complete this play after use cases have been prioritized and before the agency commits to pilots, procurement, staffing, vendor services, technology changes, or implementation plan sequencing that requires ongoing resources.",
    implementationTips: [
...
const addedToolGuidanceByPlay = {
  ...
  2: [
    [7, "Use the Readiness Findings Validation & Improvement Plan as the core Play 2 workspace. Import the preliminary pathway findings, confirm or revise them with evidence, classify gaps, assign actions and approvals, document pause or proceed decisions, and schedule reassessment."],
    ...
    [33, "Use the Funding Strategy Checklists when readiness improvements depend on grant allowability, budget timing, staffing, or sustainment decisions."],
    [39, "Use the Technical Infrastructure Readiness Checklist when the assessment identifies uncertain environments, access controls, integrations, monitoring, or secure deployment paths."]
  ],
  3: [
  ...
  9: [
    ...
    [37, "Use the Implementation Plan Dependency and Risk Register to keep unresolved dependencies, risks, mitigation steps, owners, due dates, and escalation decisions visible."],
...
const exampleDetails = {
  ...
  "Use Tool 7 during Play 2": "Import the Pathway Assessment results, validate findings with organizational evidence, classify gaps, and assign readiness improvements before selecting pilots.",
...
const caseStudies = [
  ...
  {
    title: "Kansas Local Health Department AI Playbook and Tools",
    agency: "Kansas Public Health Collaborative with Kansas local health departments",
    type: "AI adoption playbook and tools",
    challenge: "Local health departments need practical guidance on whether and how to use AI for routine operations, communications, grant writing, health literacy, content review, and other public health workflows without creating privacy, quality, or trust risks.",
    solution: "The Kansas Public Health Collaborative created AI guidance and playbook resources for local health departments, including practical AI tools and FAQs for communications, grant writing, health literacy, campaign planning, and content review.",
    ...
    workflow: "Local health departments can use the playbook and tools to move from informal experimentation toward structured, governed use of AI in communications, administrative workflows, health literacy, grant support, and other public health operations.",
...
const glossaryGroups = [
  ...
  },
  {
    ...
    terms: [
      ...
      ["AI use case", "A specific way AI will be used to support a public health task or workflow. A strong AI use case identifies the public health purpose, affected users or populations, data involved, AI function, expected benefit, human review process, risks, and measures of success."],
      ["Decision rights", "The defined authority to approve, reject, pause, revise, monitor, or retire an AI use. Decision rights should be explicit because AI decisions often cross program, technology, legal, privacy, procurement, and public accountability boundaries."],
      ["Escalation", "The process for raising a question, concern, incident, or proposed high-risk AI use to the appropriate reviewer or governance body. Staff should know when and how to escalate privacy concerns, incorrect outputs, potential bias, unsafe recommendations, public communication risks, vendor issues, or unapproved use."],
      ...
      ["Human accountability", "The principle that a person or accountable role remains responsible for reviewing AI outputs, interpreting context, making decisions, documenting rationale, and responding to errors. AI should not become the invisible decision-maker in a public health workflow."],
      ...
      ["Oversight", "Ongoing review of AI use after approval, including performance monitoring, incident review, equity and usability checks, confirmation that approval conditions are followed, and decisions about whether the AI use should continue, change, pause, or be retired."],
      ...
      ["Risk tier", "A category used to determine the level of review required for an AI use. A low-risk internal drafting aid may not need the same review as a tool that prioritizes field response, summarizes case narratives, identifies high-risk communities, or generates public-facing recommendations."],
...
const glossaryAdditionsByCategory = {
  ...
  "Governance, Privacy, and Accountability": [
    ...
    ["Indigenous Data Sovereignty", "The right of Indigenous Peoples and Nations to govern data about them, their citizens, lands, resources, knowledge, and communities."],
...
const backgroundMaterial = {
  "understanding-ai": {
    sections: [
      { title: "What AI Means for Public Health", body: "Artificial intelligence is a family of methods that enable computer systems to learn from data, recognize patterns, classify information, estimate risk, forecast events, extract meaning from text, generate new content, retrieve evidence, and support action toward defined goals. For public health agencies, responsible AI planning needs to cover predictive models, machine learning, natural language processing, retrieval tools, generative AI, agentic workflows, automation, and AI-enabled vendor systems." },
    ...
    bulletsTitle: "Foundational concepts",
    bullets: [
      "AI is not one technology or one product category. In public health, the word AI may refer to predictive models, classification tools, spatial analytics, anomaly detection, natural-language processing, generative drafting systems, retrieval tools, automation inside vendor platforms, or agentic workflows that coordinate several steps. Treating these as interchangeable can lead to poor procurement choices, weak safeguards, and confusion about who is accountable for decisions.",
  ...
  "risks": {
    sections: [
      { title: "Risk Is Operational", body: "AI risks are especially consequential in public health because errors can affect trust, equity, privacy, resource allocation, inspections, surveillance, outreach, service access, and public communication. Predictive, generative, agentic, analytic, and vendor-enabled systems each need safeguards matched to the workflow and potential impact." }
    ],
    risks: [
...
const learningModuleDeepDive = {
  ...
  "deep-research": {
    ...
    sections: [
      ...
      { title: "Actionable Output", items: ["Ask for a decision-ready format: summary, implications for STLT public health, risks, resource needs, equity considerations, and recommended next steps.", "Convert the research output into a tool artifact such as a policy scan, gap register, governance memo, funding brief, or implementation plan.", "Update scans when guidance, funding rules, laws, or evidence change."] }
    ]
  },
  "workflows": {
...
const newsItems = [
  ...
  },
  {
    ...
    summary: "California announced a statewide arrangement to make Claude available to government agencies at reduced cost, reinforcing the need for procurement, access controls, approved-use guidance, and workforce training before broad AI access expands.",
...
function renderLearningSection(section) {
  ...
  if (paragraphs.length) return paragraphs.map(paragraph => `<p>${paragraph}</p>`).join("");
    ...
    <section class="page">
      ...
      <section class="panel playbook-overview">
        ...
        <div class="overview-grid">
          <article class="mini-card"><h3>Understand AI</h3><p>Build a shared baseline on predictive AI, machine learning, NLP, retrieval, generative AI, agentic AI, Deep Research, public health workflows, risks, limitations, and guardrails before making implementation decisions.</p></article>
      ...
      <section class="panel playbook-overview">
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>
        <tr><td>Readiness and planning</td><td>Assess organizational readiness, validate findings, assign gap-closure work, evaluate data and infrastructure, and prepare for later implementation planning.</td><td>Pathway Assessment, Tool 7 Readiness Findings Validation &amp; Improvement Plan, Tool 9 Data Quality Checklist, Tool 39 Technical Infrastructure Readiness Checklist</td></tr>
      ...
      <section class="panel background-panel">
        ...
        <p>AI can support surveillance, forecasting, risk stratification, communication, evidence synthesis, language access, workflow coordination, decision briefing, quality improvement, and monitoring, but only when agencies pair the technology with governance, equity safeguards, privacy controls, validation, and human review.</p>
        <div class="workflow-grid">
          <article class="mini-card"><h3>Predictive AI + Machine Learning</h3><p>Supports forecasting, risk stratification, classification, anomaly detection, spatial analysis, and trend monitoring when data quality and validation are strong.</p><a href="#/learn/predictive-ai">Read background</a></article>
          ...
          <article class="mini-card"><h3>NLP, Retrieval, and Knowledge Tools</h3><p>Help extract, search, classify, and summarize public health documents, records, guidance, and evidence when sources are approved and reviewed.</p><a href="#/learn/deep-research">Read background</a></article>
...
const foundationalCourseIds = ["INT 100", "INT 190", "INT 250", "GOV 100", "GOV 110", "ANL 330", "COM 200"];
...
const learningAssessmentRoleQuestions = {
  ...
  "Informatics / Data Director": ["I can document readiness across data quality, provenance, standards, interoperability, infrastructure, and system-of-record requirements.", "I can define enforceable access, stewardship, retention, lineage, quality, and lifecycle controls for AI data and outputs.", "I can recommend build, buy, integrate, or defer using program requirements, architecture constraints, vendor evidence, and total cost."],
  "Program Manager": ["I can complete a use-case intake that defines the problem, affected populations, workflow, benefits, alternatives, measures, and risks.", "I can build an implementation plan with RASCI roles, milestones, dependencies, training, adoption measures, and stop or scale criteria.", "I can route and document required legal, privacy, security, equity, procurement, community, and governance reviews."],
  "IT / Technical Lead": ["I can produce or review an architecture and data-flow design covering integration, identity, permissions, logging, security, and system-of-record controls.", "I can conduct technical and vendor due diligence, test claims and failure modes, and translate findings into acceptance criteria and contract requirements.", "I can implement monitoring, incident response, rollback, change control, business continuity, and retirement controls."],
  "Communications": ["I can design an approved AI-assisted content workflow with authoritative sources, fact-checking, named reviewers, records, and final human approval.", "I can test content for misinformation, disclosure, accessibility, readability, translation quality, cultural context, and community trust.", "I can document approval, publication, feedback, correction, and escalation procedures for AI-assisted public communications."],
...
const learningAssessmentRoleQuestionExtensions = {
  "Health Officer / Executive": ["I can sponsor workforce preparation, change management, and sustainable operating capacity—not only technology acquisition.", "I can require portfolio-level measures for value, equity, safety, adoption, incidents, and resource use.", "I can ensure community accountability and cross-jurisdiction coordination are proportionate to the impact of the AI use."],
  "Epidemiologist": ["I can determine whether training, test, and comparison data are fit for the population, place, time, and surveillance purpose.", "I can document reproducibility, analytic provenance, assumptions, and limitations for internal and external review.", "I can monitor changing data, performance, behavior, and epidemiologic context and recommend recalibration, suspension, or retirement.", "I can communicate uncertainty and appropriate interpretation to incident command, programs, clinicians, leaders, and the public."],
  "Informatics / Data Director": ["I can establish data-product ownership, metadata, lineage, versioning, access, and quality-accountability practices.", "I can evaluate privacy-preserving, de-identification, linkage, and data-minimization options without assuming HIPAA is the only standard.", "I can define monitoring and audit evidence across data pipelines, models, interfaces, vendors, and downstream consumers.", "I can plan portability, continuity, exit, migration, and retirement to reduce vendor and infrastructure dependency."],
  "Program Manager": ["I can define user acceptance, workflow, quality, equity, value, and safety measures with owners and review dates.", "I can manage vendor, staffing, funding, dependency, adoption, and change risks through an active issue and decision process.", "I can prepare evidence for stage-gate decisions and recommend whether to continue, modify, scale, pause, or retire the use."],
  "IT / Technical Lead": ["I can conduct threat modeling for prompt injection, data leakage, insecure tools, excessive permissions, model abuse, and third-party compromise.", "I can define test environments, acceptance testing, release controls, versioning, observability, and audit logging.", "I can establish performance, availability, latency, cost, environmental-resource, and capacity thresholds.", "I can produce technical evidence that nontechnical governance reviewers can understand and use in a decision."],
  "Communications": ["I can define when and how the agency discloses AI assistance without confusing audiences or overstating automation.", "I can involve qualified language, accessibility, community, scientific, and program reviewers based on audience and risk.", "I can monitor public response, misinformation, errors, disparities, and trust signals and trigger timely correction or withdrawal."],
  "Policy / Legal / Privacy": ["I can analyze data flows, purpose, authority, disclosure, retention, vendor use, model training, and secondary-use risks across the lifecycle.", "I can assess due process, explainability, contestability, accessibility, discrimination, labor, and community-impact implications.", "I can define incident, breach, complaint, appeal, correction, enforcement, and records-preservation requirements.", "I can communicate uncertainty and unresolved questions without presenting legal review as a generic approval stamp."],
  "Governance Committee Member": ["I can distinguish committee oversight from the separate authority of legal, privacy, security, records, procurement, program, executive, and community decision-makers.", "I can evaluate evidence of public value, alternatives, proportionality, validation, equity, privacy, security, workforce readiness, and sustainability.", "I can document conditions, dissent, unresolved evidence, expiration dates, and triggers for re-review.", "I can maintain an inventory and reporting process that gives leadership and affected communities meaningful visibility."],
  "Operations / Data Quality": ["I can conduct user acceptance testing with frontline staff and affected workflows before operational release.", "I can define who may override an output, how the override is recorded, and when repeated overrides trigger investigation.", "I can measure workload displacement, new burden, service access, downstream effects, and unintended consequences."],
  "Health Educator": ["I can set role-based learning objectives that align with agency policy, approved tools, workflow responsibilities, and escalation routes.", "I can facilitate scenario-based practice and provide feedback on decisions, documentation, and safeguards.", "I can maintain training records, identify persistent gaps, and trigger refresher or remedial learning when policies, tools, or risks change."],
  "Researcher / Analyst": ["I can document data provenance, preprocessing, feature choices, code or prompt versions, and analytic decisions for reproducibility.", "I can choose meaningful comparators and evaluate whether added model complexity produces proportional public health value.", "I can plan independent review, external validity assessment, monitoring, and reanalysis when data or context changes.", "I can protect individuals and communities through appropriate authority, minimization, governance, and disclosure practices."],
  "Student / Learner": ["I can recognize that public health data may require protection even when a specific HIPAA rule does not apply."]
};

Object.entries(learningAssessmentRoleQuestionExtensions).forEach(([role, questions]) => learningAssessmentRoleQuestions[role]?.push(...questions));
      ...
      <div class="framework-intro">
        ...
        <section class="use-playbook-panel">
          ...
          <ul>
            ...
            <li>Leverage existing data and technology governance infrastructure wherever possible, including data governance councils, IT governance, cybersecurity review, privacy review, records management, procurement review, and project management processes.</li>
    ...
    <div class="guide-layout">
      <article class="panel guide-page">
        ...
        <section class="content-section">
          ...
          <ul class="check-list">
            <li>A plain-language overview of AI types relevant to public health, including predictive AI, machine learning, natural language processing, retrieval, generative AI, agentic AI, and AI-enabled automation.</li>
  ...
  main.innerHTML = pageIntro("Guidance: Conducting the AI Readiness Assessment", "Use the readiness assessment as a planning tool to identify strengths, gaps, risks, blocking issues, and the next plays to complete before selecting, piloting, procuring, or scaling AI use cases.") + `
    <div class="guide-layout">
      <article class="panel guide-page">
        <section class="content-section">
          <h2>Purpose of This Guidance</h2>
          <p>The toolbar Pathway Assessment helps a public health department develop preliminary findings about whether it has the leadership, governance, data, workforce, equity, partnership, privacy, and security capacity needed to prepare for responsible AI use. Play 2 then validates those findings with organizational evidence and converts confirmed gaps into assigned improvement work.</p>
        ...
        <section class="content-section">
          ...
          <ul class="check-list">
            ...
            <li>Before beginning Play 2, so the preliminary findings can be imported into the validation and improvement plan.</li>
      ...
      <aside class="detail-card-list">
        ...
        <section class="panel"><h2>Core Play 2 Tool</h2><p>${toolLink(7)}</p></section>
        <section class="panel"><h2>Supporting Tools by Readiness Area</h2>
          <p><strong>Policy and decision boundaries</strong><br>${[4,5,6].map(toolLink).join("<br>")}</p>
          <p><strong>Equity and community</strong><br>${[3,20,21].map(toolLink).join("<br>")}</p>
          <p><strong>Data and technology</strong><br>${[9,10,39].map(toolLink).join("<br>")}</p>
          <p><strong>Workforce</strong><br>${[24,26,28].map(toolLink).join("<br>")}</p>
          <p><strong>Funding and sustainability</strong><br>${[33,35].map(toolLink).join("<br>")}</p>
        </section>
        ...
        <section class="panel"><h2>Next Steps</h2><div class="button-row"><a class="btn small" href="#/plays/2">Back to Play 2</a><a class="btn small" href="#/assess">Take Pathway Assessment</a><a class="btn small" href="#/toolkit/7">Open Validation Plan</a></div></section>
      </aside>
    </div>
  </section>`;
}
      ...
      <article class="panel guide-page">
        ...
        <section class="content-section">
          ...
          <ol>
            ...
            <li><strong>Define the scope of governance.</strong> Cover staff use of AI tools, predictive models, generative AI, vendor AI products, AI-assisted surveillance, public-facing content, workflow automation, sensitive data use, partner tools, and internally developed systems.</li>
        ...
        <section class="content-section">
          ...
          <div class="table-wrap"><table><thead><tr><th>Later Play</th><th>How Stakeholder Engagement Supports It</th></tr></thead><tbody>
            ${[
              ...
              ["Play 9: Develop the AI Implementation Plan", "Helps sequence work based on operational dependencies, funding assumptions, and partner readiness."],
...
function hydratePlay2AssessmentBridge(target = "play") {
  document.getElementById("import-assessment-play2")?.addEventListener("click", () => {
    ...
    setMemberState(state);
    if (target === "tool") renderToolDetail(7); else renderPlayDetail(2);
  });
    ...
    <div class="toolkit-layout">
      ...
      <section>
        <section class="panel tool-fit-note">
          ...
          <p>Where data governance, technology governance, privacy, cybersecurity, procurement, records-management, or IT review processes already exist, use those processes as the starting point and adapt the toolkit only where AI creates new decisions, documentation needs, or oversight gaps.</p>
        </section>
...
function renderToolDetail(id) {
  ...
  if (t.id === 7) hydratePlay2AssessmentBridge("tool");
...
function renderCaseStudies() {
  main.innerHTML = pageIntro("Case Studies", "AI examples from public health and health agency contexts, including generative AI, retrieval, agentic workflows, predictive analytics, machine learning, and AI-enabled decision support. Each case study uses the same structure so agencies can compare the public health challenge, AI-enabled workflow, data inputs, outcomes, and governance considerations.") + `
...
const curriculumModuleAliases = {
  ...
  "environmental-impact": "int-250-environmental-and-resource-impacts-of-ai",

...
const tools = [
  ...
  [28,"AI Training Completion and Competency Tracker",[5,10],"Track staff participation, role-based competency progress, completion evidence, refresher needs, and training follow-up.","Tracker","Workforce",["Training","Supervisors","AI champions"],"Readiness",false],
  ...
  [49,"Role-Based Training Plan and Completion Tracker",[5,10],"Assign learning modules by role, set completion standards, track deadlines, verify completion, and identify follow-up support needs.","Tracker","Workforce",["Training","Supervisors","Organization administrators","AI champions"],"Readiness",false]
...
const toolFormBlueprints = {
  ...
  28: [["Training cohort", ["Training period", "Audience or staff group", "Required learning modules", "Facilitator or training owner", "Completion standard"]], ["Competency tracking", ["Participant or role", "Required competency level", "Training completed", "Evidence of competency", "Supervisor verification"]], ["Follow-up plan", ["Staff needing additional support", "Refresher training needed", "Champion or mentor assigned", "Due date", "Status"]]],
...
const toolOutputOverrides = {
  ...
  28: [
    ...
    "Training cohort, audience, required modules, facilitator, and completion standard.",
    "Participant or role-level completion record.",
    "Competency evidence and supervisor verification.",
    "Follow-up plan for additional support, refresher training, champion assignment, and due dates."
  ],
  49: [
...
const readinessGapRecommendations = {
  ...
  "Workforce Capacity": { plays: [5, 6, 10], tools: [23,24,26,28,49,29,30] },
...
const maturityLevels = [
  ...
  { level: 2, title: "Readiness", focus: "Planning and preparation", plays: [2,3,4,5,6,7,8,9], risks: "Overcommitting before data, workforce, governance, change, or funding gaps are addressed.", activities: "Assess readiness, establish governance, engage stakeholders, plan workforce and change management, prioritize use cases, align funding, design roadmap.", tools: [7,33,36,23,24,26,49,31,12] },
...
const exampleDetails = {
  ...
  "Use Tools 41 and 42 before scaling": "Use the pilot dashboard and scale decision framework to determine whether to scale, revise, pause, or retire a pilot."
};
    ...
    <section class="page">
      ...
      <section class="panel playbook-overview">
        ...
        <tr><td>Workforce and change</td><td>Prepare staff for responsible AI adoption through competencies, champions, training, communication, and barrier identification.</td><td>Tool 23 Change Management Plan, Tool 24 Workforce Competency Framework, Tool 29 Staff Communication and FAQ, Tool 30 Barrier Identification</td></tr>
              <tr><td>Deployment and evaluation</td><td>Support infrastructure readiness, model testing, pilot evaluation, scale decisions, monitoring, audits, and continuous improvement.</td><td>Tools 39-42 for deployment, Tools 44-45 for monitoring, Tools 17-18 and 46 for governance review and policy maintenance</td></tr>
            </tbody>
          </table>
        </div>
  ...
  return `
    <section class="panel training-dashboard">
      <div class="org-workspace-header">
        ...
        <a class="btn small" href="#/toolkit/49">Open Tool 49</a>
      </div>
      <div class="member-stats change-stats">
        <article><strong>${escapeDoc(trainingItem.status || "Not started")}</strong><span>Tool 49 status</span></article>
      ...
      ${savedTrainingPlan ? `
        <div class="change-form-dashboard">
          <div class="change-form-header">
            ...
            <a class="btn small" href="#/toolkit/49">Update Tool 49</a>
          </div>
          <div class="change-profile-grid">
          ...
          <div class="change-dashboard-grid">
            ...
            <article>
              <h3>Dashboard source</h3>
              <p>This section is populated from the latest saved Tool 49: Role-Based Training Plan and Completion Tracker.</p>
            </article>
          </div>
        </div>
      ` : `
        <div class="change-form-empty">
          <div>
            <h3>No saved Tool 49 training plan yet</h3>
            <p>Complete and save Tool 49 to populate this dashboard with role-based learning module assignments, completion standards, deadlines, verification, and follow-up support needs.</p>
          </div>
          <a class="btn primary" href="#/toolkit/49">Open Tool 49</a>
        </div>
      `}
    </section>`;
}
...
function renderOrganizationTrainingHub() {
  ...
  main.innerHTML = pageIntro("Organization Training Assignments", "Assign learning modules to organization members based on role, track completion standards and deadlines, and document verification or follow-up support needs.") + `
    <section class="member-dashboard panel org-dashboard-hero">
      ...
      <div class="button-row"><button class="btn primary small" type="button" onclick="saveOrganizationTrainingAssignmentsFromForm()" ${isOrgAdmin ? "" : "disabled"}>Save Training Assignments</button><a class="btn small" href="#/organization">Back to Dashboard</a><a class="btn small" href="#/learn">Open Learning Modules</a><a class="btn small" href="#/toolkit/49">Open Tool 49</a></div>

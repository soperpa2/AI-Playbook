...
<div class="detail-layout"><article class="page-panel">
  ...
  <section class="page-panel tool-panel" id="starter-tool" data-content-id="${play.tool.id}"><p class="eyebrow">Included Starter Tool</p><h2>${play.tool.title}</h2><p>${play.tool.purpose}</p><p class="availability">This Starter Tool is included in the Foundation Edition. It provides a useful next step without reproducing the complete organizational toolkit or protected facilitation method.</p><a class="button primary" href="index.html#updates">Get release updates</a></section>
